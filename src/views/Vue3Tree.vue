<template>
  <div class="tree-container">
          ...
          <a-card title="节点详情" class="inner-card">
            ...
            <div v-else>
              <a-descriptions :column="1" bordered>
                <a-descriptions-item label="节点ID">{{ currentNode.id || currentNode.key }}</a-descriptions-item>
                <a-descriptions-item label="节点名称">{{ currentNode.label || currentNode.title }}</a-descriptions-item>
                <a-descriptions-item label="创建时间">{{ currentNode.createTime || '2023-04-01 12:00:00' }}</a-descriptions-item>
                <a-descriptions-item label="更新时间">{{ currentNode.updateTime || '2023-04-01 12:00:00' }}</a-descriptions-item>
              </a-descriptions>
            </div>
          </a-card>
        </a-row>
    ...
    >
      <a-form>
        ...
        <a-form-item label="节点名称">
          <a-input :value="addForm.title" @update:value="updateAddFormTitle" placeholder="请输入节点名称" />
        </a-form-item>
      </a-form>
    </a-modal>
    ...
    >
      <a-form>
        <a-form-item label="节点名称">
          <a-input :value="editForm.title" @update:value="updateEditFormTitle" placeholder="请输入节点名称" />
        </a-form-item>
      </a-form>
    </a-modal>
  </div>
